          ...
          children: [
            Obx(
              () => CircleAvatar(
                backgroundImage: controller
                        .doctorProfilePicture.value.isNotEmpty
                    ? NetworkImage(controller.doctorProfilePicture.value)
                    : NetworkImage(
            ...
            Column(
              ...
              children: [
                Obx(
                  () => Text(
                    controller.doctorName.value.isNotEmpty
                        ? controller
                            .doctorName.value // Nama dokter dari controller
                        : 'Unknown Doctor', // Placeholder jika nama kosong
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (isSender)
                                Icon(
                                  message.isRead
                                      ? Icons.done_all // Double check if read
                                      : Icons
                                          .done, // Single check if sent but not read
